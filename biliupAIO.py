...
import json
try:
    keystamps = json.load(open('/tf/out/keystamps.json', 'r'))
except:
    ...
    keystamps = {
        ...
        '黑泽诺亚NOIR':[
            r'https://live.bilibili.com/251015',
            '关注黑泽诺亚NOIR泽宝：https://space.bilibili.com/922573/channel/series',
        ],
    }
    json.dump(keystamps, open('/tf/out/keystamps.json','w'))
